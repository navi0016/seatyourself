...
20.times do
  ...
  Reservation.create! reservation_time: rand(res.start_time..res.end_time).beginning_of_hour , party_size: rand(2..10) , user_id:User.all.sample.id , restaurant_id: res.id, duration: 1
end
